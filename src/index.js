...
app.use("/organisation/livestock", requireSection("livestock"));
app.use("/organisation/services-wip", requireSection("services-wip"));
app.use("/resources/lessor", requireSection("lessor"));
...
// The API layer, split into 5 files matching this system's own
// architectural documentation (Business / Operational / Accounting /
